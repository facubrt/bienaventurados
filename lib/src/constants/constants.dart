...
const String INSTRUCTIONS_FOR_FLYING_SUBTITLE = '(o de cómo sacar a pasear los avioncitos por muchos corazones y lugares)';
const String INSTRUCTIONS_FOR_BUILDING_TITLE = 'Instrucciones para construir';
const String INSTRUCTIONS_FOR_BUILDING_SUBTITLE = '(o de cómo encender un corazón y abrazar al otro construyendo un mundo de esperanza)';
const String INSTRUCTIONS_FOR_SHARING_TITLE = 'Instrucciones para compartir';
const String INSTRUCTIONS_FOR_SHARING_SUBTITLE = '(o de cómo ser luz y compartir la fe para que el amor de Dios llegue a todas partes)';
...
const double SCALE_H2 = 0.08;
const double SCALE_H3 = 0.06;
