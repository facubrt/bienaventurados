                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Icon(Iconsax.save_2, color: Theme.of(context).primaryColorDark, size: MediaQuery.of(context).size.width * 0.06,),
                    ),
                  ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text('${avioncitoGuardado.fecha!.day} de ${MesesData.meses[avioncitoGuardado.fecha!.month-1].id}, ${avioncitoGuardado.fecha!.year}'.toUpperCase(), style:Theme.of(context).textTheme.bodyText2!.copyWith(fontSize: MediaQuery.of(context).size.width * 0.028,),),
              Spacer(),
              IconButton(
                onPressed: () {
